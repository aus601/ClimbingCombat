...
// Cross Module References
	...
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetAngularOffset();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FRotator();
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetConstraintReferenceFrame();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FTransform();
	ENGINE_API UEnum* Z_Construct_UEnum_Engine_EConstraintFrame();
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetCurrentLinearDistance();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetGlobalPose();
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVREPhysicsConstraintComponent_GetLocalPose();
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVREPhysicsConstraintComponent_SetAngularOffset();
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVREPhysicsConstraintComponent_SetConstraintToForceBased();
// End Cross Module References
	...
	IMPLEMENT_CLASS(UVREPhysicsConstraintComponent, 1481747009);
